...
function propanel_siteoptions_add_admin() {
    ...
    $tt_page = add_menu_page('تنظیمات قالب', 'تنظیمات قالب', 'manage_options', 'siteoptions','propanel_siteoptions_options_page','dashicons-exerpt-view');
...
<div class="wrap" id="truethemes_container">
  <div id="of-popup-save" class="of-save-popup">
    <div class="of-save-save">تنظیمات ذخیره شد</div>
  </div>
  <div id="of-popup-reset" class="of-save-popup">
    <div class="of-save-reset">تنظیمات به حالت اول بازگشت</div>
  </div>
  ...
  <form action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" method="post" style="display:inline" id="ofform-reset">
    ...
    <input name="reset" type="submit" value="بازگردانی تنظیمات به حالت پیشفرض" class="button submit-button reset-button" onclick="return confirm('CAUTION: Any and all settings will be lost! Click OK to reset.');" />
